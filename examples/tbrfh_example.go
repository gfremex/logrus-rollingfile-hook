...
func main() {
	// fileNamePattern is a string including supported date/time conversion specifications as described in
	...
	// fileNamePattern is "/tmp/tbrfh/%Y/%m/%d/%H/minute.%M.log"
	...
	// and so on.
	// If fileNamePattern is "/tmp/tbrfh/%Y/%m/%d/%H/minute.%M.log.gz", old file will be archived
